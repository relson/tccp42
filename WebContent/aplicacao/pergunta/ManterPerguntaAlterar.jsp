...
<title>UNIP CCP42 - Analisador Financeiro [Página Administração - Manter Pergunta(Alterar)]</title>
...
<% 
	...
	try
	{
		...
		int codigo = Integer.parseInt(request.getParameter("perguntaCodigo"));
		...
		{	 	
	 		String nomeParametro = "opcao[" + opcao.getCodigo() + "]";
	 	...
	 	%>
	 		<h2>Pergunta Atualizada com sucesso</h2>
	 	<% 
	}
	catch(Exception ex) {
		%>			
